...
<div class="modal fade" id="add_room" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
			...
			<div class="modal-body mt-lg">
					<div class="form-group">
						<div class="col-md-12">
							...
							<input type="text" class="form-control" required name="room_name" value=""/>
						</div>
					</div>
					<div class="form-group" >
						<div class="col-md-12">
							...
							<div class="radio-inline">                                   
								<input type="radio" name="room_status" value="1" checked>
								<label for="">Active</label>
								&nbsp; &nbsp;
								<input type="radio" name="room_status" value="2">
